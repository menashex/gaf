$installPath = (Get-ItemProperty -ErrorAction SilentlyContinue "HKLM:\SOFTWARE\Wow6432Node\Cisco\Cisco UCS PowerTool Suite").InstallPath
if (!$installPath)
{
	$installPath = (Get-ItemProperty -ErrorAction SilentlyContinue "HKLM:\SOFTWARE\Cisco\Cisco UCS PowerTool Suite").InstallPath
}
		
if ($installPath)
{	
	$path = $installPath + "\Cisco.UCSCentral\Cisco.UCSCentral.psd1"
}

Import-Module $path

write-host "          Welcome to Cisco UCS Central PowerTool"
write-host ""
...
write-host "Get-UcsCentralPSSession" -foregroundcolor yellow
write-host "If you need more help, visit the UCS Central PowerTool user community:	  " -NoNewLine
write-host "Get-UcsPowerToolCommunity" -foregroundcolor yellow
write-host ""

$version = Get-UcsPowerToolConfiguration
$windowTitle = "Cisco UCS Central PowerTool {0}" -f $version.Version
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAK1rmfelz5+dP0
# 6CNOowKcBxK3JIMJfvYGIjOksoUvYKCCEx0wggQVMIIC/aADAgECAgsEAAAAAAEx
...
# CSqGSIb3DQEJBDEiBCA7KLmpk/OViaGbx8iWXFh5rR76JaU/49vo0qkl3dLfdDAN
# BgkqhkiG9w0BAQEFAASCAQAiyrTtas62wiedGJh+2P7a1q6wjJ0ej0oFLfQTu0mZ
# UVVrNleVtNFrqWJooODzgAGM7GpGToBT+lMOtiJkh2Lnzda3nGlBcIeEvrzuj4Cn
# q7vzuvmyHBCYZLUAdYQThm5yLgiID3pOAgfDbjarNjfMyVk8sGLlJYNZCHuzi47V
# L7DDm0UJWdskDy4wEE+mwmqKHXl048/LvaXd8uRFPjEmcyotNFmNfWb5tu2pceML
# cgjK9/DoWYoGoO0bPwCRPu7ABU8p+OE/X7j5ao4UPUABEEZCeYMCcBjQ9d9rqpwS
# rKGtVH7wxSxGydYgzw2B9QcD2NGCEfCvLy24tcS1ABlDoYICuTCCArUGCSqGSIb3
...
# MTUwNTIwWjAvBgkqhkiG9w0BCQQxIgQgH9LOOGJmKawqaaydRqmHAC1v1rqEMyk8
# ucdchKNTxFwwgaAGCyqGSIb3DQEJEAIMMYGQMIGNMIGKMIGHBBQ+x2bV1NRy4hsf
...
# LSBTSEEyNTYgLSBHMgIMJFS4fx4UU603+qF4MA0GCSqGSIb3DQEBAQUABIIBAE0N
# TNI0Z4cBJsuMV6K/y9CeuvimTo+SotEb8cy0cPWYLzqajTgKsqmEF9xNCVanXyyt
# 3kf5wRBo2Sm9Ezu06Fuwj5fn1yD8WDvW1IjYq55BBgkTLNLeVzV/GN7ViRc442Yb
# cgbJ6dUTTE+nGqsEkS/uUuGzpmcQnTKKqLr1/6eXSkHnQ7NzHyxD3K7+7mS7KmT0
# /72lVEAAEG3OddOovorPRJG7de6lv9BrQzu4ZZ5Z7tdZaIO7MDxi9Ve3rre5BnHD
# +vidmPsz/jwVMlQJ5HEQEugwzp0lJMgA9ZUiigcejWurAXO69LL6L168ZFH1TTnw
# 6/YdkiPMkI7EL596q24=
