...
if ($installPath)
{	
	$path = $installPath + "\Cisco.UCSManager\Cisco.UCSManager.psd1"
}

Import-Module $path

write-host "          Welcome to Cisco UCS Manager PowerTool"
write-host ""
...
write-host "Once you've connected, display all service profiles:              " -NoNewLine
write-host "Get-UcsServiceProfile" -foregroundcolor yellow
...
$windowTitle = "Cisco UCS Manager PowerTool {0}" -f $version.Version
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCArQdU3aiPWbi2l
# Zi5bVlfQdmTBXmnnwrQYbQTW5yOHDaCCEx0wggQVMIIC/aADAgECAgsEAAAAAAEx
...
# CSqGSIb3DQEJBDEiBCB/dLF4ReC8bVAZz4auARWXaG/Sf8pKb9y8pH2cnS41oTAN
# BgkqhkiG9w0BAQEFAASCAQCC5X3q9cd6tVJbO83Oe/preG745wFZPrOhkYkfD8SZ
# GsstQQh6BUydMWBJsw9xLnrecQXX5ysY9Efq57r2spwSCcGX1sFo5GTFnAX/zDlk
# FcavFhVYQGXFUQIC0fWn9bjBKP8OL7/9jhheEYauhKGHKKYcgU+o3LDX82jiuoVT
# H5le0HDqgjbOFxL484sEexS3M6t5/raSWydWAk9BfWdX6Q69MAhyfvf5nAkpz1X5
# C2fgOjVbgR81O5ffWbLh6nnSBaOGnVRE/y8ZOxD6egAMOpnHR79YQAXlG6OwC21k
# l3fGnoi/l3m5pN4rafTLPXbvplM1nfoByPQXymDFb9AloYICuTCCArUGCSqGSIb3
...
# MTUwNTMxWjAvBgkqhkiG9w0BCQQxIgQg4D+RVhBna4V+W2xobpX/mfCZ4EEnAhPz
# WZ18RqR/b80wgaAGCyqGSIb3DQEJEAIMMYGQMIGNMIGKMIGHBBQ+x2bV1NRy4hsf
...
# LSBTSEEyNTYgLSBHMgIMJFS4fx4UU603+qF4MA0GCSqGSIb3DQEBAQUABIIBAIun
# mjzHojbiWdxMrVJheHBrmLw+vMKbpK045Im2VEmq0i7gOzIN6HH4v9xOlZAIULdS
# /SJiv+i5hpzG5GZ6onkgfke9zt/uHiZDI7BiEyJSrVNkGAjedYl+QGa3jDWnm+Z1
# mQ1p1zrUY2d6msdhtcvwJ5ohPG1kwvsjiIL2G/XgvEjPM/0/ptN1dSSX/XyxczGY
# iLxiL3iJ0Br3V5mbw3ijLeS76t5ZnPA/yNkt1zJ7a3+xsRnofHRM32pE6QppDCRO
# o6/EJ02zM1QzsPdcHPUH4wKCCaPGqtqi+7aXuFNHn9fMOnwyP0aC+F9l8gQy/Chx
# CSBRCBnxAytS1PatZZU=
