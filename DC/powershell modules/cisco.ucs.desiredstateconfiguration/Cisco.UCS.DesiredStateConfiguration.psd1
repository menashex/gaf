#
# Module manifest for module 'Cisco.UCS.DesiredStateConfiguration'
#
...
ModuleVersion = '2.4.1.3'

# Supported PSEditions
# CompatiblePSEditions = @()

# ID used to uniquely identify this module
GUID = '6d7a3c12-9c99-44a7-b049-e2e9b6beda60'
...
Description = 'PowerShell Module for Cisco DSC Resources (DSC module in Cisco PowerTool Suite)'
...
NestedModules = @('Cisco.UCS.DesiredStateConfiguration.psm1')

# Functions to export from this module, for best performance, do not use wildcards and do not delete the entry, use an empty array if there are no functions to export.
FunctionsToExport = 'Get-UcsConnection', 'Get-ImcConnection'
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCB2VmDvJrfxY+Aq
# ul80BvXEaPHdDSbkvNIsP5ZLX9MJiaCCEx0wggQVMIIC/aADAgECAgsEAAAAAAEx
...
# CSqGSIb3DQEJBDEiBCCifL9lLNLDnrsHF6hym/UMoqaIafuuNRGfgxBapMcU4zAN
# BgkqhkiG9w0BAQEFAASCAQBgM5Ug+dgIVR4JE66U7CVtdthIewyK6lnWt5ZLiJvy
# cThpDZjNmdi7QSWU7lWxUJ8R231O2BEh7UTemN+08MCEqnwkVjUN4XGxD4jMK1a9
# t6MeRs0benCvrt6zIK+1wSbszur0khi9ln+Iq2m1my2Bv6AbCy9HQIBwB1E/ErFu
# 9AoaXFGpsHe1xpzm3ejumRbsbphuD3tE/d1zyZZ57qNyuOETiaLWs/HgZ5s76eV0
# afr+a04gfJMfYAIuCKiXWexXSwuPl42xRV4IYhWY327R4e06toHBF+sZPuIAHRIZ
# EP/wsQWAfMSOIQd0rKAvAM/xx3PC4qBoiF7dYz4VRYnEoYICuTCCArUGCSqGSIb3
...
# MTUwMDIwWjAvBgkqhkiG9w0BCQQxIgQg8zb/AQM6x/I22Obxq3+AgJiW2z3yusPu
# T1xmlTObdhswgaAGCyqGSIb3DQEJEAIMMYGQMIGNMIGKMIGHBBQ+x2bV1NRy4hsf
...
# LSBTSEEyNTYgLSBHMgIMJFS4fx4UU603+qF4MA0GCSqGSIb3DQEBAQUABIIBAKL3
# gxVD46Hvf8F4061NL6d6fS+o7wYx8YEDtDkRgC9JNEJAPx7lbQIF9Y4YvFt7dAB+
# 7bXMkD2++j3VEkWk11jgtjvnrLQiEaqQLBhGrMHw5Inu32Z+bvY11nkg4yAOR1IP
# 8P8ZCez7YNvfRYBMEsdA/zfD0fuHWGA9W3TS1yhYV8sAn/d9teNPxLhgShTE3ar3
# eFRXSnhhDrzip1qovnGN6LjcUFWOa7mY5XeLxV6j/i7u08CxYdOvqte1JTs1gMxD
# GVgKkjs0fIEePRAasC9t59/03WOiK0AujvG3pT917LPs3J/THEWU/9xe8zgAzXGD
# bDDIyUAceznKQ3YO+RI=
